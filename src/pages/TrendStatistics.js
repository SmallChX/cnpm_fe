...
function TrendStatistics() {
  ...
  const activityList = [
    {
      activityNumber: "0000001",
      activityName: "Trực phát thiết bị đồ án đa ngành",
      activityTime: "27/10/2023",
      studentAmount: 10,
      holder: "Le Phan Thuy Tien",
      state: "Đã kết thúc",
    },
    {
      activityNumber: "0000001",
      ...
      <div class="row statistics-bar statistics-bar-inside">
        ...
        <div class="col-md-4 statistics-infor">
          ...
          <div class="button-group">
            ...
            {showConfirmation && (
              <PrintConfirmationPopup onConfirm={handleConfirmRegistration} />
            )}
